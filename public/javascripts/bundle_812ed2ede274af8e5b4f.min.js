...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoginView = __webpack_require__(101);

	var _LoginView2 = _interopRequireDefault(_LoginView);

	var _GamesListView = __webpack_require__(111);

	var _GamesListView2 = _interopRequireDefault(_GamesListView);

	var _GameView = __webpack_require__(114);
	...
	router.map({
	  ...
	  '/games': {
	    component: _GamesListView2.default,
	    subRoutes: {
	      '/demo': {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/gigavinyl/Projects/terriblecards/src/components/App.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports) {
	...
	module.exports = "<router-view keep-alive=\"\" transition=\"\" transition-mode=\"out-in\" class=\"view\"></router-view>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/LoginView.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/gigavinyl/Projects/terriblecards/src/components/LoginView.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	exports.default = {
	  ...
	  methods: {
	    addNewUser: function addNewUser() {
	      ...
	      if (text) {
	        _store2.default.actions.newUser({
	          name: text,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mutations = __webpack_require__(109);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _devtool = __webpack_require__(106);
...
/***/ function(module, exports) {
	...
	exports.default = {
	  newUser: function newUser(store, name) {
	    socket.emit('new user', name);
	    store.dispatch('NEW_USER', name);
	  },
	  newQuestion: function newQuestion(store) {
	    socket.emit('request question', store.questions);
	  },
	  newAnswers: function newAnswers(store) {}
	};
...
/***/ function(module, exports) {
	...
	exports.default = {
	  NEW_USER: function NEW_USER(state, name) {
	    state.user = name;
	    state.users.push(name);
	  },
	  LOAD_CARDS: function LOAD_CARDS(state, questions, answers) {
	    state.questions = questions;
	    state.answers = answers.map(function (card) {
	      card.owner = '';
	      return card;
	    });
	  },
	  INCREMENT_POINTS: function INCREMENT_POINTS(state, userID) {
	  ...
	  NEW_QUESTION: function NEW_QUESTION(state, question) {
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"container-fluid\"><div class=\"center-block\"><h2>TerribleCards: an online game of Cards Against Humanity. Please enter a screen name.</h2><input v-model=\"newUser\" @keyup.enter=\"addNewUser\"/></div></div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/GamesListView.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/gigavinyl/Projects/terriblecards/src/components/GamesListView.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	module.exports = "<nav class=\"navbar navbar-default fixed-top\"><div class=\"container-fluid\"><div class=\"navbar-header\"><button type=\"button\" data-toggle=\"collapse\" data-target=\"#navbar-collapse\" aria-expanded=\"false\" class=\"navbar-toggle collapsed\"><span class=\"sr-only\">Toggle navigation</span><span class=\"icon-bar\"></span><span class=\"icon-bar\"></span><span class=\"icon-bar\"></span></button><a v-link=\"'games'\" class=\"navbar-brand\">{{ user.name }} @ {{ user.id }}</a><ul class=\"nav navbar-nav\"><li><a v-link=\"{path: '/games/demo'}\">Create New Game</a></li></ul></div></div></nav><div class=\"container-fluid\"></div><router-view keep-alive=\"\" transition=\"\" transition-mode=\"out-in\" class=\"view\"></router-view>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src/components/GameView.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/gigavinyl/Projects/terriblecards/src/components/GameView.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  data: function data() {
	    return {
	      currentQuestion: _store2.default.state.currentQuestion
	    };
	  },
	  ...
	  computed: {
	    ...
	    users: function users() {
	      return _store2.default.state.users;
	    },
	    questions: function questions() {
	      return _store2.default.state.questions;
	    },
	    answers: function answers() {
	      return _store2.default.state.answers;
	    }
	  },
	  ready: function ready() {
	    _store2.default.actions.loadCards();
	  }
	};
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"container-fluid\"><ul class=\"list-group\"><li v-for=\"otherUser in users\" class=\"list-group-item\">{{ otherUser.name }}<span class=\"badge\">{{ otherUser.points }}</span></li></ul><ul class=\"list-group\"><li class=\"list-group-item\">{{ currentQuestion.text }}</li></ul></div>";
